...
export const MOTS = {
  ...
  // Étape 16, rattachement des sorts et des dons du corpus.
  corpusRechercherSorts: 'Rechercher un sort',
  corpusRechercherDons: 'Rechercher un don',
  corpusChampRecherche: 'Nom à chercher',
  corpusAucunResultat: 'Aucun résultat.',
  corpusResultatChargement: 'Chargement du moteur de recherche.',
  corpusResultatEchec: 'Le moteur de recherche n’a pas pu être chargé.',
  corpusBoutonRattacher: 'Rattacher',
  corpusBoutonLire: 'Lire',
  corpusBoutonDetacher: 'Détacher',
  corpusVerdictEligible: 'Aucune condition en travers',
  corpusVerdictManuel: 'À vérifier',
  corpusVerdictIneligible: 'Condition non remplie',
  corpusMotifsIndetermines: 'Points à vérifier soi-même',
  corpusMotifsNonRemplis: 'Ce que le personnage ne remplit pas',
  corpusVerificationImpossible: 'La vérification n’est pas possible avec cette fiche.',
  corpusVerificationImpossibleDetail: 'Une classe et un niveau sont nécessaires pour vérifier les conditions d’un don.',
  panneauFermer: 'Fermer',
  sortsModePrepareLibelle: 'Préparé',
  sortsModePrepareTexte: 'La classe prépare une liste de sorts à l’avance, choisie parmi ceux qu’elle connaît.',
  sortsModeSpontaneLibelle: 'Spontané',
  sortsModeSpontaneTexte: 'La classe lance directement parmi les sorts qu’elle connaît, sans préparation.',
  sortsModeUsageLimiteLibelle: 'Usage limité par jour',
  sortsModeUsageLimiteTexte: 'La classe dispose d’un nombre de fois par jour pour chaque sort, sans emplacement ni préparation.',
  sortsModeAucunLibelle: 'Aucun mode choisi',
  sortsConnusTitre: 'Sorts connus',
