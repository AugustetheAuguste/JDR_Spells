 ...
 * single spell page — not an icon in a corner. The Skill (B8) asks for the same
 * link a second time, above the fold under the spell name; that copy is in
 * `app/sorts/[slug]/page.tsx`, this block stays the footer form.
 *
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 mb-3 max-w-[68ch] text-corps text-encre-douce">
        La page d&apos;origine sur <strong>pathfinder-fr.org</strong>, wiki communautaire
        tenu par des bénévoles, fait foi.
      </p>
      <a
        className="inline-flex min-h-cible min-w-cible items-center rounded-jeton border border-accent bg-accent-voile px-3 py-2 text-corps font-medium text-accent underline hover:bg-survol"
        href={url}
        rel="noreferrer"
        target="_blank"
      >
